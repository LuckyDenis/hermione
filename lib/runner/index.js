...
const createRunnerWorkers = require('./create-runner-workers');
...
module.exports = class MainRunner extends Runner {
    constructor(config, interceptors) {
        ...
        this._workersRegistry = WorkersRegistry.create();
        this._workers = createRunnerWorkers(this._workersRegistry, this._config);
    ...
    async run(testCollection, stats) {
        ...
        try {
            await this.emitAndWait(Events.WORKERS_START, this._workersRegistry);
            ...
            await this.emitAndWait(Events.WORKERS_END);
            this._workersRegistry.endAll();
        }
    }
